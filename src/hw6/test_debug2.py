...
def match(string1, string2):
    ...
    common consecutive substring shared, but this one is coded wrong
    ...
    return best_length
def match_fix(string1, string2):
    """
    Identifies and returns the length of a longest
    common consecutive substring shared, but this one is coded right
    by the two input strings.
    :param string1: The first string.
    :param string2: The second string.
    :return: length of a longest shared consecutive string.
        ...
        for idx2 in range(len(string2)-1):
            ...
            if string1[idx1] == string2[idx2]:
                ...
                while string1[idx1 + this_match_count] == \
                        string2[idx2 + this_match_count]:
                    this_match_count += 1
                    if (idx1 + this_match_count >= len(string1)) or (idx2 + this_match_count >= len(string2)):
                        if this_match_count > best_length:
                            best_length = this_match_count
                            return best_length
                        else:
    ...
    return best_length
def test():
    for func in [match, match_fix]:
        print( func.__name__, end=": " )
        print( func("established" ,"ajdlasdlishklda" ) == 4, end=" " )
        print( func("dasasadasa" ,"xasasasasasasasasasax" ) == 5, end=" " )
        print( func("looped" ,"poodle" ) == 2, end=" " )
        print( func("basement" ,"assemblance" ) == 3, end=" " )
        print( func("fishel" ,"shelled" ) == 4, end=" " )
        print( func("lpoof" ,"fpool" ) == 3, end=" " )
